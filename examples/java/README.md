...
2. Rode o exemplo Java.
3. Acesse `http://localhost:3000`.
4. Consulte traces em `Explore` com o datasource `Tempo`.
5. Consulte métricas no datasource `Prometheus` procurando por `java_example_runs_total`.
